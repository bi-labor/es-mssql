...
A prepared VM template with name "BI laboratory MSSQL" is available in two data centers of the BME cloud. Go to <https://niif.cloud.bme.hu>, <https://fured.cloud.bme.hu> or <https://smallville.cloud.bme.hu> and log in with your EduID. Find the template and use it to create a VM that has all the necessary software installed.
